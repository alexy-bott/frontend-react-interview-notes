...
<!-- NOTE-NAV-TOP:START -->
[← React 18 и 19](<./32 React 18 и 19.md>) · [↑ React](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [React Compiler →](<./34 React Compiler.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Серверные и клиентские компоненты](<../Next.js/03 Серверные и клиентские компоненты.md>)
- [Server Actions и Route Handlers](<../Next.js/06 Server Actions и Route Handlers.md>)
