...
<!-- NOTE-NAV-TOP:START -->
[← Управляемые и неуправляемые компоненты](<./18 Управляемые и неуправляемые компоненты.md>) · [↑ React](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Пакетное обновление (Batching) →](<./20 Пакетное обновление (Batching).md>)
<!-- NOTE-NAV-TOP:END -->
