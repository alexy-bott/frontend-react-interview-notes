...
<!-- NOTE-NAV-TOP:START -->
[← useCallback](<./14 useCallback.md>) · [↑ React](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Мемоизация →](<./16 Мемоизация.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Debounce и throttle](<../JavaScript/42 Debounce и throttle.md>)
