...
<!-- NOTE-NAV-TOP:START -->
[← Хуки](<./10 Хуки.md>) · [↑ React](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [useEffect и useLayoutEffect →](<./12 useEffect и useLayoutEffect.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Чистая функция](<../JavaScript/17 Чистая функция.md>)
