...
<!-- NOTE-NAV-TOP:START -->
[← Zustand](<./26 Zustand.md>) · [↑ React](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Гидратация (Hydration) →](<./28 Гидратация (Hydration).md>)
<!-- NOTE-NAV-TOP:END -->
...
- [SSR, SSG, ISR и Streaming](<../Next.js/04 SSR, SSG, ISR и Streaming.md>)
- [Получение данных, кеш и ревалидация](<../Next.js/05 Получение данных, кеш и ревалидация.md>)
