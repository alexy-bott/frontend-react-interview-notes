...
<!-- NOTE-NAV-TOP:START -->
[← Bundlers и code splitting](<./Bundlers и code splitting.md>) · [↑ Web Basics](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Core Web Vitals →](<./Core Web Vitals.md>)
<!-- NOTE-NAV-TOP:END -->
...
Детали layout, paint и composite разобраны отдельно в [Rendering pipeline reflow repaint composite](<../Browser Internals/Rendering pipeline reflow repaint composite.md>). В этой карточке важен путь первоначального документа до видимого результата.
