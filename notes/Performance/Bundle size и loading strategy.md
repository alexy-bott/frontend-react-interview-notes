# Bundle size и loading strategy

<!-- NOTE-NAV-TOP:START -->
[← Core Web Vitals LCP INP CLS](<./Core Web Vitals LCP INP CLS.md>) · [↑ Performance](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [React performance profiling →](<./React performance profiling.md>)
<!-- NOTE-NAV-TOP:END -->
