# Env files и frontend переменные

<!-- NOTE-NAV-TOP:START -->
[← Воспроизводимые версии в команде](<./Воспроизводимые версии в команде.md>) · [↑ Tooling](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [ESLint Prettier и code quality configs →](<./ESLint Prettier и code quality configs.md>)
<!-- NOTE-NAV-TOP:END -->
...
- Правила хранения/rotation secrets раскрыты отдельно в [Env variables и секреты](<../DevOps/Env variables и секреты.md>).
