# Bundle analysis и size budgets

<!-- NOTE-NAV-TOP:START -->
[← Gitignore npmrc README и служебные файлы](<./Gitignore npmrc README и служебные файлы.md>) · [↑ Tooling](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Vite →](<./Vite.md>)
<!-- NOTE-NAV-TOP:END -->
