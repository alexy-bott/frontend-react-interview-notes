# ESLint Prettier и code quality configs

<!-- NOTE-NAV-TOP:START -->
[← Env files и frontend переменные](<./Env files и frontend переменные.md>) · [↑ Tooling](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Gitignore npmrc README и служебные файлы →](<./Gitignore npmrc README и служебные файлы.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Правила хуков](<../React/Правила хуков.md>)
