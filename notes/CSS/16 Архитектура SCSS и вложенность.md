# Архитектура SCSS и вложенность

<!-- NOTE-NAV-TOP:START -->
[← Переменные, миксины и функции SCSS](<./15 Переменные, миксины и функции SCSS.md>) · [↑ CSS](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Центрирование →](<./17 Центрирование.md>)
<!-- NOTE-NAV-TOP:END -->
