# Переменные, миксины и функции SCSS

<!-- NOTE-NAV-TOP:START -->
[← Модули SCSS — @use и @forward](<./14 Модули SCSS — @use и @forward.md>) · [↑ CSS](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Архитектура SCSS и вложенность →](<./16 Архитектура SCSS и вложенность.md>)
<!-- NOTE-NAV-TOP:END -->
