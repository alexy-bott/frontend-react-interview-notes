...
<!-- NOTE-NAV-TOP:START -->
[← Псевдоклассы и псевдоэлементы](<./03 Псевдоклассы и псевдоэлементы.md>) · [↑ CSS](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [display и контексты форматирования →](<./05 display и контексты форматирования.md>)
<!-- NOTE-NAV-TOP:END -->
