# SSR, SSG, ISR и Streaming

<!-- NOTE-NAV-TOP:START -->
[← Серверные и клиентские компоненты](<./03 Серверные и клиентские компоненты.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Получение данных, кеш и ревалидация →](<./05 Получение данных, кеш и ревалидация.md>)
<!-- NOTE-NAV-TOP:END -->
