# Получение данных, кеш и ревалидация

<!-- NOTE-NAV-TOP:START -->
[← SSR, SSG, ISR и Streaming](<./04 SSR, SSG, ISR и Streaming.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Server Actions и Route Handlers →](<./06 Server Actions и Route Handlers.md>)
<!-- NOTE-NAV-TOP:END -->
