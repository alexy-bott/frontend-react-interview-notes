...
<!-- NOTE-NAV-TOP:START -->
[← Server Actions и Route Handlers](<./Server Actions и Route Handlers.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Docker для frontend](<../DevOps/Docker для frontend.md>)
