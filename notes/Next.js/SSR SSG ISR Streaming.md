...
<!-- NOTE-NAV-TOP:START -->
[← Server и Client Components](<./Server и Client Components.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Data fetching cache revalidation →](<./Data fetching cache revalidation.md>)
<!-- NOTE-NAV-TOP:END -->
