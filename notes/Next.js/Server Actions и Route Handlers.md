...
<!-- NOTE-NAV-TOP:START -->
[← Data fetching cache revalidation](<./Data fetching cache revalidation.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Deployment env Docker →](<./Deployment env Docker.md>)
<!-- NOTE-NAV-TOP:END -->
