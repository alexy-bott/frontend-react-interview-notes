...
<!-- NOTE-NAV-TOP:START -->
[← SSR SSG ISR Streaming](<./SSR SSG ISR Streaming.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Server Actions и Route Handlers →](<./Server Actions и Route Handlers.md>)
<!-- NOTE-NAV-TOP:END -->
