# Деплой, переменные окружения и Docker

<!-- NOTE-NAV-TOP:START -->
[← Server Actions и Route Handlers](<./06 Server Actions и Route Handlers.md>) · [↑ Next.js](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Docker для фронтенда](<../DevOps/01 Docker для фронтенда.md>)
