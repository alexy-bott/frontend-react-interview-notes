...
<!-- NOTE-NAV-TOP:START -->
[← React Testing Library](<./04 React Testing Library.md>) · [↑ Тестирование](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Асинхронный UI, формы и авторизация →](<./06 Асинхронный UI, формы и авторизация.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [HTTP-запрос](<../Основы веб-платформы/04 HTTP-запрос.md>)
