# Factory Singleton и lifecycle

<!-- NOTE-NAV-TOP:START -->
[← Observer PubSub и события](<./Observer PubSub и события.md>) · [↑ Patterns](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Compound Components и Headless UI →](<./Compound Components и Headless UI.md>)
<!-- NOTE-NAV-TOP:END -->
