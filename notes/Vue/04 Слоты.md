...
<!-- NOTE-NAV-TOP:START -->
[← Виртуальный DOM](<./03 Виртуальный DOM.md>) · [↑ Vue](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Жизненный цикл →](<./05 Жизненный цикл.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Преимущества React](<../React/01 Преимущества React.md>)
