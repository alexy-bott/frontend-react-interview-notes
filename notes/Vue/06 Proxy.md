...
<!-- NOTE-NAV-TOP:START -->
[← Жизненный цикл](<./05 Жизненный цикл.md>) · [↑ Vue](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Прототипы](<../JavaScript/18 Прототипы.md>)
- [Проверка свойств объекта](<../JavaScript/21 Проверка свойств объекта.md>)
