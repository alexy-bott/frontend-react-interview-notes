# Dockerfile и multi-stage build

<!-- NOTE-NAV-TOP:START -->
[← Docker для frontend](<./Docker для frontend.md>) · [↑ DevOps](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Nginx и static serving →](<./Nginx и static serving.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [package.json и lock-файлы](<../Tooling/package.json и lock-файлы.md>)
