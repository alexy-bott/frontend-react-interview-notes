# CI-CD-пайплайн фронтенда

<!-- NOTE-NAV-TOP:START -->
[← GitLab CI-CD](<./06 GitLab CI-CD.md>) · [↑ DevOps](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [package.json и lock-файлы](<../Инструменты разработки/02 package.json и lock-файлы.md>)
...
- [E2E-тестирование](<../Тестирование/07 E2E-тестирование.md>)
