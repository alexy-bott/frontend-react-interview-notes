...
<!-- NOTE-NAV-TOP:START -->
[← Артефакты, кеш и переменные пайплайна](<./05 Артефакты, кеш и переменные пайплайна.md>) · [↑ DevOps](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [CI-CD-пайплайн фронтенда →](<./07 CI-CD-пайплайн фронтенда.md>)
<!-- NOTE-NAV-TOP:END -->
