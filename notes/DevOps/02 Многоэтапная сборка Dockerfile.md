...
<!-- NOTE-NAV-TOP:START -->
[← Docker для фронтенда](<./01 Docker для фронтенда.md>) · [↑ DevOps](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Nginx и раздача статических файлов →](<./03 Nginx и раздача статических файлов.md>)
<!-- NOTE-NAV-TOP:END -->
