# Nginx и раздача статических файлов

<!-- NOTE-NAV-TOP:START -->
[← Многоэтапная сборка Dockerfile](<./02 Многоэтапная сборка Dockerfile.md>) · [↑ DevOps](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Переменные окружения и секреты →](<./04 Переменные окружения и секреты.md>)
<!-- NOTE-NAV-TOP:END -->
