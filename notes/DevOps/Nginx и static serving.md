# Nginx и static serving

<!-- NOTE-NAV-TOP:START -->
[← Dockerfile и multi-stage build](<./Dockerfile и multi-stage build.md>) · [↑ DevOps](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Env variables и секреты →](<./Env variables и секреты.md>)
<!-- NOTE-NAV-TOP:END -->
