# Критический путь рендеринга (Critical Render Path)

<!-- NOTE-NAV-TOP:START -->
[← Бандлеры и разделение кода](<./19 Бандлеры и разделение кода.md>) · [↑ Основы веб-платформы](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Core Web Vitals →](<./21 Core Web Vitals.md>)
<!-- NOTE-NAV-TOP:END -->
...
Детали layout, paint и composite разобраны отдельно в [Конвейер рендеринга — reflow, repaint и composite](<../Устройство браузера/03 Конвейер рендеринга — reflow, repaint и composite.md>). В этой карточке важен путь первоначального документа до видимого результата.
...
- [Что происходит после ввода URL](<../Устройство браузера/02 Что происходит после ввода URL.md>)
