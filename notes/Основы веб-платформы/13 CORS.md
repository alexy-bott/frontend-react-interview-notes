...
<!-- NOTE-NAV-TOP:START -->
[← Процесс авторизации и refresh-токены](<./12 Процесс авторизации и refresh-токены.md>) · [↑ Основы веб-платформы](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [XSS →](<./14 XSS.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [CORS, CSP и границы безопасности браузера](<../Безопасность/03 CORS, CSP и границы безопасности браузера.md>)
- [CSRF](<./15 CSRF.md>)
