...
Подробная диагностика каждой метрики находится в [Core Web Vitals LCP INP CLS](<../Производительность/02 Core Web Vitals — LCP, INP и CLS.md>), а работа основного потока — в [Main thread long tasks и responsiveness](<../Устройство браузера/04 Главный поток, долгие задачи и отзывчивость.md>).
