...
<!-- NOTE-NAV-TOP:START -->
[← Критический путь рендеринга (Critical Render Path)](<./20 Критический путь рендеринга (Critical Render Path).md>) · [↑ Основы веб-платформы](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Транспорты реального времени →](<./22 Транспорты реального времени.md>)
<!-- NOTE-NAV-TOP:END -->
...
Подробная диагностика каждой метрики находится в [Core Web Vitals — LCP, INP и CLS](<../Производительность/02 Core Web Vitals — LCP, INP и CLS.md>), а работа основного потока — в [Главный поток, долгие задачи и отзывчивость](<../Устройство браузера/04 Главный поток, долгие задачи и отзывчивость.md>).
