# Процесс авторизации и refresh-токены

<!-- NOTE-NAV-TOP:START -->
[← Cookie и авторизация](<./11 Cookie и авторизация.md>) · [↑ Основы веб-платформы](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [CORS →](<./13 CORS.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Авторизация и защищённые маршруты](<../Системный дизайн фронтенда/04 Авторизация и защищённые маршруты.md>)
