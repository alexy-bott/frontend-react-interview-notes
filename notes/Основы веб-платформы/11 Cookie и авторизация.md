...
<!-- NOTE-NAV-TOP:START -->
[← Хранение данных в браузере](<./10 Хранение данных в браузере.md>) · [↑ Основы веб-платформы](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Процесс авторизации и refresh-токены →](<./12 Процесс авторизации и refresh-токены.md>)
<!-- NOTE-NAV-TOP:END -->
