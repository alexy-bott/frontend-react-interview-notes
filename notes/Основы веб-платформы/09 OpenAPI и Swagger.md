...
<!-- NOTE-NAV-TOP:START -->
[← Пагинация, фильтрация и сортировка API](<./08 Пагинация, фильтрация и сортировка API.md>) · [↑ Основы веб-платформы](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Хранение данных в браузере →](<./10 Хранение данных в браузере.md>)
<!-- NOTE-NAV-TOP:END -->
