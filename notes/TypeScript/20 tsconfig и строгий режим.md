# tsconfig и строгий режим

<!-- NOTE-NAV-TOP:START -->
[← as const и satisfies](<./19 as const и satisfies.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [enum →](<./21 enum.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [npm, Yarn, pnpm и менеджеры пакетов](<../Инструменты разработки/04 npm, Yarn, pnpm и менеджеры пакетов.md>)
