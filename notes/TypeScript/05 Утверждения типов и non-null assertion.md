# Утверждения типов и non-null assertion

<!-- NOTE-NAV-TOP:START -->
[← never, any и unknown](<./04 never, any и unknown.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Объединения, пересечения и дискриминируемые объединения →](<./06 Объединения, пересечения и дискриминируемые объединения.md>)
<!-- NOTE-NAV-TOP:END -->
