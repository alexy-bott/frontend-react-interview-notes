...
Совместимость функций зависит не только от формы объекта, но и от параметров, результата и настроек вроде `strictFunctionTypes`. Эта часть подробно разобрана в [Variance и совместимость функций](<./14 Вариантность и совместимость функций.md>).
