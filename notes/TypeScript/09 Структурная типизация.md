...
<!-- NOTE-NAV-TOP:START -->
[← type и interface](<./08 type и interface.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Типизация функций →](<./10 Типизация функций.md>)
<!-- NOTE-NAV-TOP:END -->
...
Совместимость функций зависит не только от формы объекта, но и от параметров, результата и настроек вроде `strictFunctionTypes`. Эта часть подробно разобрана в [Вариантность и совместимость функций](<./14 Вариантность и совместимость функций.md>).
