# Вариантность и совместимость функций

<!-- NOTE-NAV-TOP:START -->
[← Перегрузка функций](<./13 Перегрузка функций.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Типизация Array.map →](<./15 Типизация Array.map.md>)
<!-- NOTE-NAV-TOP:END -->
