...
<!-- NOTE-NAV-TOP:START -->
[← Вывод типов, widening и контекстная типизация](<./03 Вывод типов, widening и контекстная типизация.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Утверждения типов и non-null assertion →](<./05 Утверждения типов и non-null assertion.md>)
<!-- NOTE-NAV-TOP:END -->
