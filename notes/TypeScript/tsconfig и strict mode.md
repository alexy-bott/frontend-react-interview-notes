# tsconfig и strict mode

<!-- NOTE-NAV-TOP:START -->
[← as const и satisfies](<./as const и satisfies.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [enum →](<./enum.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [npm yarn pnpm и package managers](<../Tooling/npm yarn pnpm и package managers.md>)
