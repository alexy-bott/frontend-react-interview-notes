...
<!-- NOTE-NAV-TOP:START -->
[← Вариантность и совместимость функций](<./14 Вариантность и совместимость функций.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [keyof, indexed access и mapped types →](<./16 keyof, indexed access и mapped types.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Массивы и методы массивов](<../JavaScript/26 Массивы и методы массивов.md>)
- [Комбинаторы Promise](<../JavaScript/38 Комбинаторы Promise.md>)
