...
<!-- NOTE-NAV-TOP:START -->
[← keyof indexed access mapped types](<./keyof indexed access mapped types.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [infer и conditional types →](<./infer и conditional types.md>)
<!-- NOTE-NAV-TOP:END -->
