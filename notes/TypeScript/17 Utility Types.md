...
<!-- NOTE-NAV-TOP:START -->
[← keyof, indexed access и mapped types](<./16 keyof, indexed access и mapped types.md>) · [↑ TypeScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [infer и условные типы →](<./18 infer и условные типы.md>)
<!-- NOTE-NAV-TOP:END -->
