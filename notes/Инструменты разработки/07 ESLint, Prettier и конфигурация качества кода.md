# ESLint, Prettier и конфигурация качества кода

<!-- NOTE-NAV-TOP:START -->
[← Файлы окружения и переменные фронтенда](<./06 Файлы окружения и переменные фронтенда.md>) · [↑ Инструменты разработки](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [.gitignore, .npmrc, README и служебные файлы →](<./08 .gitignore, .npmrc, README и служебные файлы.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Правила хуков](<../React/37 Правила хуков.md>)
