# Анализ бандла и бюджет размера

<!-- NOTE-NAV-TOP:START -->
[← .gitignore, .npmrc, README и служебные файлы](<./08 .gitignore, .npmrc, README и служебные файлы.md>) · [↑ Инструменты разработки](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Vite →](<./10 Vite.md>)
<!-- NOTE-NAV-TOP:END -->
