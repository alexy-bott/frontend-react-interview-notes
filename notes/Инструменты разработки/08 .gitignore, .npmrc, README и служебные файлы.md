...
<!-- NOTE-NAV-TOP:START -->
[← ESLint, Prettier и конфигурация качества кода](<./07 ESLint, Prettier и конфигурация качества кода.md>) · [↑ Инструменты разработки](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Анализ бандла и бюджет размера →](<./09 Анализ бандла и бюджет размера.md>)
<!-- NOTE-NAV-TOP:END -->
