...
<!-- NOTE-NAV-TOP:START -->
[← Файлы фронтенд-проекта](<./01 Файлы фронтенд-проекта.md>) · [↑ Инструменты разработки](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Версии зависимостей и semver →](<./03 Версии зависимостей и semver.md>)
<!-- NOTE-NAV-TOP:END -->
