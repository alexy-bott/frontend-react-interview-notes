# npm, Yarn, pnpm и менеджеры пакетов

<!-- NOTE-NAV-TOP:START -->
[← Версии зависимостей и semver](<./03 Версии зависимостей и semver.md>) · [↑ Инструменты разработки](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Воспроизводимые версии в команде →](<./05 Воспроизводимые версии в команде.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Многоэтапная сборка Dockerfile](<../DevOps/02 Многоэтапная сборка Dockerfile.md>)
