...
<!-- NOTE-NAV-TOP:START -->
[← Фабрика, одиночка и жизненный цикл](<./04 Фабрика, одиночка и жизненный цикл.md>) · [↑ Паттерны](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Композиция вместо наследования](<../Принципы разработки/03 Композиция вместо наследования.md>)
