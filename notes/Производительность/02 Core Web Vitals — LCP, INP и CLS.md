...
<!-- NOTE-NAV-TOP:START -->
[← Диагностика и профилирование производительности](<./01 Диагностика и профилирование производительности.md>) · [↑ Производительность](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Размер бандла и стратегия загрузки →](<./03 Размер бандла и стратегия загрузки.md>)
<!-- NOTE-NAV-TOP:END -->
