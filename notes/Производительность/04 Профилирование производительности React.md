...
<!-- NOTE-NAV-TOP:START -->
[← Размер бандла и стратегия загрузки](<./03 Размер бандла и стратегия загрузки.md>) · [↑ Производительность](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Изображения, шрифты и приоритет ресурсов →](<./05 Изображения, шрифты и приоритет ресурсов.md>)
<!-- NOTE-NAV-TOP:END -->
