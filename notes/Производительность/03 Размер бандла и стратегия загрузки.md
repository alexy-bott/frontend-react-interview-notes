# Размер бандла и стратегия загрузки

<!-- NOTE-NAV-TOP:START -->
[← Core Web Vitals — LCP, INP и CLS](<./02 Core Web Vitals — LCP, INP и CLS.md>) · [↑ Производительность](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Профилирование производительности React →](<./04 Профилирование производительности React.md>)
<!-- NOTE-NAV-TOP:END -->
