# Изображения, шрифты и приоритет ресурсов

<!-- NOTE-NAV-TOP:START -->
[← Профилирование производительности React](<./04 Профилирование производительности React.md>) · [↑ Производительность](<./README.md>) · [⌂ Все разделы](<../../README.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [Изображения и адаптивные медиа](<../HTML/06 Изображения и адаптивные медиа.md>)
- [head, метаданные и ресурсные подсказки](<../HTML/05 head, метаданные и ресурсные подсказки.md>)
