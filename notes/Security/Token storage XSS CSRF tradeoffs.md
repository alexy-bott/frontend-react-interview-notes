# Token storage XSS CSRF tradeoffs

<!-- NOTE-NAV-TOP:START -->
[← Frontend threat model](<./Frontend threat model.md>) · [↑ Security](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [CORS CSP и browser security boundaries →](<./CORS CSP и browser security boundaries.md>)
<!-- NOTE-NAV-TOP:END -->
