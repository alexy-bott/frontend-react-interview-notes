# Состояние формы и жизненный цикл отправки

<!-- NOTE-NAV-TOP:START -->
[← Серверные ошибки и асинхронная валидация](<./06 Серверные ошибки и асинхронная валидация.md>) · [↑ Формы](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Архитектура форм →](<./08 Архитектура форм.md>)
<!-- NOTE-NAV-TOP:END -->
