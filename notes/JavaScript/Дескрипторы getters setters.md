# Дескрипторы getters setters

<!-- NOTE-NAV-TOP:START -->
[← Классы и наследование](<./Классы и наследование.md>) · [↑ JavaScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Проверка свойств объекта →](<./Проверка свойств объекта.md>)
<!-- NOTE-NAV-TOP:END -->
...
Все операции shallow. Подробная модель immutable state находится в [Неизменяемость объектов](<./Неизменяемость объектов.md>).
