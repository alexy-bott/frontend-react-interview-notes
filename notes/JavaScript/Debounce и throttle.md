...
<!-- NOTE-NAV-TOP:START -->
[← Fetch и работа с API](<./Fetch и работа с API.md>) · [↑ JavaScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [DOM API innerHTML и layout →](<./DOM API innerHTML и layout.md>)
<!-- NOTE-NAV-TOP:END -->
...
В реальном коде нужно отдельно обработать сетевую ошибку и не показывать отмену как ошибку пользователю. Подробная модель находится в [AbortController](<./AbortController.md>).
