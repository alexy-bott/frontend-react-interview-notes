...
<!-- NOTE-NAV-TOP:START -->
[← Автоупаковка (Autoboxing)](<./06 Автоупаковка (Autoboxing).md>) · [↑ JavaScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Деструктуризация, rest и spread →](<./08 Деструктуризация, rest и spread.md>)
<!-- NOTE-NAV-TOP:END -->
...
- [never, any и unknown](<../TypeScript/04 never, any и unknown.md>)
