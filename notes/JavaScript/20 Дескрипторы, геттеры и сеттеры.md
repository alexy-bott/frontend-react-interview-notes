...
<!-- NOTE-NAV-TOP:START -->
[← Классы и наследование](<./19 Классы и наследование.md>) · [↑ JavaScript](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Проверка свойств объекта →](<./21 Проверка свойств объекта.md>)
<!-- NOTE-NAV-TOP:END -->
...
Все операции shallow. Подробная модель immutable state находится в [Неизменяемость объектов](<./23 Неизменяемость объектов.md>).
