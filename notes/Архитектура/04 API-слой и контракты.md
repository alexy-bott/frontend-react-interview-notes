...
<!-- NOTE-NAV-TOP:START -->
[← Управление состоянием](<./03 Управление состоянием.md>) · [↑ Архитектура](<./README.md>) · [⌂ Все разделы](<../../README.md>) · [Обработка ошибок и наблюдаемость →](<./05 Обработка ошибок и наблюдаемость.md>)
<!-- NOTE-NAV-TOP:END -->
