...
aliases:
  ...
  - CLS
  - web vitals
  - полевые метрики производительности
---
...
Подробная диагностика каждой метрики находится в [[Конспект для подготовки/Performance/Core Web Vitals LCP INP CLS]], а работа основного потока — в [[Конспект для подготовки/Browser Internals/Main thread long tasks и responsiveness]].
