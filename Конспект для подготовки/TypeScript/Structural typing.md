...
Совместимость функций зависит не только от формы объекта, но и от параметров, результата и настроек вроде `strictFunctionTypes`. Эта часть подробно разобрана в [[Конспект для подготовки/TypeScript/Variance и совместимость функций]].
